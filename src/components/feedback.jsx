...
export function Feedback() {
    return (
      ...
      <div className="mb-4 flex items-center justify-between">
        <h5 className="text-xl font-bold leading-none text-gray-900 dark:text-white">Latest Customers feedback</h5>
            ...
            <div className="flex items-center space-x-4">
              <div className="shrink-0">
                <Image
                  ...
                  height="42"
                //   image 1
                  src="https://i.pinimg.com/474x/ea/9a/a7/ea9aa744ffdfaeba85f26c9e5e01f253.jpg"
                  width="42"
                  className="rounded-full hover:scale-150 transition-transform"
                />
              </div>
            ...
            <div className="flex items-center space-x-4">
              <div className="shrink-0">
                <Image
                  ...
                  height="32"
                  // image 2
                  src="https://i.pinimg.com/236x/92/98/a1/9298a118392138333cd3847971137ff5.jpg"
                  width="32"
                  className="rounded-full hover:scale-150 transition-transform"
                />
              </div>
            ...
            <div className="flex items-center space-x-4">
              <div className="shrink-0">
                <Image
                  ...
                  height="32"
                  // image 3
                  src="https://i.pinimg.com/236x/98/a9/44/98a944f8e9ac4b54060b7c353afcb6f1.jpg"
                  width="32"
                  className="rounded-full hover:scale-150 transition-transform"
                />
              </div>
            ...
            <div className="flex items-center space-x-4">
              <div className="shrink-0">
                <Image
                  ...
                  height="32"
                  // image 4
                  src="https://i.pinimg.com/236x/a6/4d/99/a64d99e00c561f0a4800bf2cf485bd4f.jpg"
                  width="32"
                  className="rounded-full hover:scale-150 transition-transform"
                />
              </div>
            ...
            <div className="flex items-center space-x-4">
              <div className="shrink-0">
                <Image
                  ...
                  height="32"
                  // image 5
                  src="https://i.pinimg.com/236x/f2/70/6f/f2706f73b1dcc75d732444525cee5a97.jpg"
                  width="32"
                  className="rounded-full hover:scale-150 transition-transform"
                />
              </div>
